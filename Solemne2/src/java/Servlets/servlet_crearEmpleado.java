 ...
 * @author Felipe
 */
@WebServlet(name = "servlet_crearEmpleado", urlPatterns = {"/servlet_crearEmpleado"})

public class servlet_crearEmpleado extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(servlet_crearEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
